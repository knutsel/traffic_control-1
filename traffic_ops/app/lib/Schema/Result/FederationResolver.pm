...
=head2 C<idx_44582_federation_resolver_ip_address>
...
__PACKAGE__->add_unique_constraint("idx_44582_federation_resolver_ip_address", ["ip_address"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:85LJwWVXl3w3VuPan6Tkzw
