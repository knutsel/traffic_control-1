...
__PACKAGE__->add_unique_constraint("idx_44732_ip6_profile", ["ip6_address", "profile"]);

=head2 C<idx_44732_ip_profile>
...
__PACKAGE__->add_unique_constraint("idx_44732_ip_profile", ["ip_address", "profile"]);

=head2 C<idx_44732_se_id_unique>
...
__PACKAGE__->add_unique_constraint("idx_44732_se_id_unique", ["id"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:GbTctjSlkQktABklV+LMoQ
