...
=head2 C<idx_44491_cr_id_unique>
...
__PACKAGE__->add_unique_constraint("idx_44491_cr_id_unique", ["id"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Qgv5gjDAAGSa7puVXM5O3w
